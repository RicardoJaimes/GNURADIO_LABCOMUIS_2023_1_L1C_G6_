...
# Title: lab1_ounto2_muetsreo
# Author: Ricardo_jaimes_L1C_G6
...
class lab1_punto2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "lab1_ounto2_muetsreo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab1_ounto2_muetsreo")
